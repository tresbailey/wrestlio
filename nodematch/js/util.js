...
move = new Move({move_id: "stalling2", move_name: "STALLING 2", point_value: 1, from_position: "NEUTRAL"});
move_lookup.stalling2 = move;
move = new Move({move_id: "stalling3", move_name: "STALLING 3", point_value: 2, from_position: "NEUTRAL"});
move_lookup.stalling3 = move;
move = new Move({move_id: "switch", move_name: "SWITCH", point_value: 2, from_position: "BOTTOM", actor_effect: "TOP", victim_effect: "BOTTOM"});
move_lookup.switch = move;
move = new Move({move_id: "standup", move_name: "STANDUP", point_value: 1, from_position: "BOTTOM", actor_effect: "NEUTRAL", victim_effect: "NEUTRAL"});
move_lookup.standup = move;
move = new Move({move_id: "backpoints", move_name: "BACKPOINTS", point_value: 2, from_position: "TOP", actor_effect: "TOP", victim_effect: "BOTTOM"});
move_lookup.backpoints = move;
move = new Move({move_id: "nearfall", move_name: "NEARFALL", point_value: 3, from_position: "TOP", actor_effect: "TOP", victim_effect: "BOTTOM"});
